...
/** Absolute path of this omh installation's package.json (both anchors: src/ and lib/ sit one level under apps/cli). */
...
const PROFILE_ROOT_CONFIG = `# omh profile root — an empty entry list. The tree is composed as patches:
